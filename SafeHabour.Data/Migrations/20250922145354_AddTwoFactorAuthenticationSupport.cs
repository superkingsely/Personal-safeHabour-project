        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsStripeConnectEnabled = table.Column<bool>(type: "bit", nullable: false),
                    UserIdentificationDocumentPath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    UserLocationDocumentPath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ServiceWorkerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schedules_Users_ServiceWorkerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceWorkerUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceWorkerUsers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Applications_Users_ServiceWorkerId",
                        column: x => x.ServiceWorkerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payments_Users_ServiceWorkerId",
                        column: x => x.ServiceWorkerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transfers_Users_ServiceWorkerId",
                        column: x => x.ServiceWorkerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applications_ServiceWorkerId",
                table: "Applications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedules_ServiceWorkerId",
                table: "Schedules",
                column: "ServiceWorkerId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceWorkerUsers_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transfers_ServiceWorkerId",
                table: "Transfers",
                column: "ServiceWorkerId");

            migrationBuilder.CreateIndex(
                name: "IX_TwoFactorAuthCodes_ExpiresAt",
                table: "TwoFactorAuthCodes",
                column: "ExpiresAt");

            migrationBuilder.CreateIndex(
                name: "IX_TwoFactorAuthCodes_UserId_Code",
                table: "TwoFactorAuthCodes",
